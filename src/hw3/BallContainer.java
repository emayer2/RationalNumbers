...
public class BallContainer implements Iterable<Ball> {
    ...
    // Total volume of all Ball's in contents
    private double volume;
    
    // Total number of Ball's in contents
    private int size;
    /**
    ...
    public boolean add(Ball b) {
    	...
    	// If the ball was successfully added, add it's volume to the
    	// total volume, and increment the number of Ball's in the set.
    	boolean added = contents.add(b);
    	if (added) {
    ...
    public boolean remove(Ball b) {
    	...
    	// If the ball was successfully removed, subtract it's volume
    	// from the total volume in the set, and decrement the number of
    	// Ball's in our set.
    	boolean removed = contents.remove(b);
    	if (removed) {
    		volume = volume - b.getVolume();
    		size = size - 1;
    	}
    ...
    public double getVolume() {
    	...
    	// Returns the stored total volume of the set
    	return volume;
    }
    ...
    public int size() {
    	...
    	// Returns the stored size of the container
    	return size;
    }
    ...
    public void clear() {
    	...
    	// Removes all items in the set, and resets the volume
    ...
    public boolean contains(Ball b) {
    	...
    	// Set.contains() returned true is the ball is contained,
    	// and false elsewise.
